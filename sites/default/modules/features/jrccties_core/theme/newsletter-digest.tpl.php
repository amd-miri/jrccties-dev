            ...
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="newsletter-text">
                  ...
                  <p style="margin:0;"><b><?php echo t('Dear !realname', array('!realname' => $realname)); ?>,</b></p>
                  <p style="margin-top: 10px;">
                    <?php echo t('Welcome to our monthly community newsletter. Your fellow community members create, discuss and share new comments, ideas, event information and news. We hope to keep you updated just in case you missed what happened last month in your community.'); ?>
                  </p>
                  <p style="margin-top: 10px;"> <?php echo t('Kindest regards,'); ?> </p>
                  <p style="margin-top: 10px;"> <?php echo t('The JRC community support team'); ?></p>
        ...
        <tr>
          <td>
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="newsletter-text">
                  <p style="margin-top: 30px;"> <?php echo t('You are receiving this newsletter because you previously ticked that box when becoming a member of the community. While you can !unsubscribe_link, we hope you continue to subscribe to our monthly newsletter.', array('!unsubscribe_link' => $unsubscribe_link)); ?> </p>
                </td>
              </tr>
            </table>
          </td>
